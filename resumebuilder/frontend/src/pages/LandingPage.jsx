...
const LandingPage = () => {
  ...
  return (
    <div className={landingPageStyles.container}>
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          ...
          <button className={landingPageStyles.mobileMenuButton} onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            {mobileMenuOpen ? <X className={landingPageStyles.mobileMenuIcon} size={24} /> : <Menu className={landingPageStyles.mobileMenuIcon} size={24} />}
          </button>
          ...
          <div className="hidden md:flex items-center">
            {user ? (
              ...
              <button className={landingPageStyles.desktopAuthButton} onClick={() => setOpenAuthModel(true)}>
                ...
                <span className={landingPageStyles.desktopAuthButtonText}>GetStarted</span>
              </button>
            )}
          </div>
        </div>
        ...
        <section className={landingPageStyles.heroSection}>
          <div className={landingPageStyles.heroGrid}>
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>Create Job winnning resumes with expertly designed templates. ATS-friendly, recruiter-approved, and tailored to your career goals.</p>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              <h2 className={landingPageStyles.featuresTitle}>
                Why Choose
                <span className={landingPageStyles.featuresTitleGradient}> ResumeXpert?</span>
              </h2>
              <p className={landingPageStyles.featuresDescription}>Everything you need to create is professional resume that stands out</p>
            </div>
              ...
              {[
                ...
                <div className={landingPageStyles.featureCard} key={index}>
                  ...
                  <div className={`${landingPageStyles.featureCardContent} ${feature.bg}`}>
                    <div className={`${landingPageStyles.featureIconContainer} ${feature.gradient}`}>{feature.icon}</div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white to-violet-50 border border-violet-100 rounded-3xl p-8 sm:p-16">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6">
                  Ready to build your <span className="bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent">Standout Resume?</span>
                </h2>

                <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto font-medium">Join thousands of professionals who landed their dream jobs with our platform</p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by{" Hanzla Yaqoob"}
          </p>
        </div>
      </footer>
      ...
      >
        <div>
          {currentPage === "login" && <Login setCurrentPage={setCurrentPage}></Login>}
          {currentPage === "signup" && <SignUp setCurrentPage={setCurrentPage}></SignUp>}
        </div>
      </Modal>
    </div>
  );
