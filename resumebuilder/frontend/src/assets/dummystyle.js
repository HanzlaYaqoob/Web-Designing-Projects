export const landingPageStyles = {
  ...
  // Auth buttons
  desktopAuthButton:
    "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
  ...
  heroGrid: "flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12",
  heroLeft: "flex-1 space-y-4 text-center lg:text-left",

  tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-1 bg-gradient-to-r from-violet-100 to-fuchsia-100 border border-violet-200 text-violet-700 rounded-full font-bold text-xs sm:text-sm",
  ...
  // Buttons
  primaryButton:
    "group relative px-10 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  // Hero illustration
  heroIllustration: "flex-1 relative w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto",
  ...
  featureCardContent: " bg-gradient-to-br border border-white/50 p-6 sm:p-8 rounded-3xl hover:shadow-2xl transition-all group-hover:scale-105",
  ...
  ctaButton:
    "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
...
export const dashboardStyles = {
  ...
  // New Resume Card
  newResumeCard:
    "flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-blue-50 border-2 border-dashed border-violet-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-violet-500 h-full",
...
export const inputStyles = {
  ...
  inputContainer: (focused) =>
    `relative flex items-center bg-gray-50 border-2 px-4 py-3 rounded-xl transition-all duration-300 ${
      focused ? "border-violet-500 ring-4 ring-violet-500/20 shadow-lg shadow-violet-500/10" : "border-gray-300 hover:border-gray-400"
    }`,
...
export const photoSelectorStyles = {
  ...
  previewImageContainer: (hovered) =>
    `w-32 h-32 sm:w-36 sm:h-36 rounded-full overflow-hidden border-4 border-gray-200 shadow-lg transition-all duration-300 ${hovered ? "group-hover:border-violet-400" : ""}`,
...
export const infoStyles = {
  ...
  progressBar: (color) => `h-full rounded-full transition-all`, // eslint-disable-line no-unused-vars
  ...
  certYear: (bgColor) => `text-xs font-bold text-white px-3 py-1 rounded-lg`, // eslint-disable-line no-unused-vars
  ...
  workDuration: (color) => `text-sm font-bold italic`, // eslint-disable-line no-unused-vars
